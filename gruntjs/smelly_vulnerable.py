...
with open('Grunt_vulnerabilities_smells_file-grain.csv',"w",newline='') as csv_file:
...
with open('Grunt_vulnerabilities_smells_line-grain.csv',"w",newline='') as csv_file:
    writer = csv.writer(csv_file, delimiter=',')
    for line in final_data:
        writer.writerow(line)
...
# On enregistre nos informations dans un csv, sachant qu'on a traité ici les liens entre smells et vulnérabilités à la granularité du fichier
with open('Grunt_vulnerabilities_smells_line-grain_large.csv',"w",newline='') as csv_file:
    writer = csv.writer(csv_file, delimiter=',')
    for line in final_data:
        writer.writerow(line)
